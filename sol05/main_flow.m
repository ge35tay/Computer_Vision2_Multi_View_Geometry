...
%% compute flow and visualize for different values of kappa
computeFlowAndVisualize(I1, I2, sigma, kappa, theta, 'Default');
computeFlowAndVisualize(I1, I2, sigma/2, kappa, theta, 'Sigma/2');
computeFlowAndVisualize(I1, I2, sigma*2, kappa, theta, 'Sigma*2');


%% Function to compute the Flow and visualize the results
function computeFlowAndVisualize(I1, I2, sigma, kappa, theta, nameWindow)
